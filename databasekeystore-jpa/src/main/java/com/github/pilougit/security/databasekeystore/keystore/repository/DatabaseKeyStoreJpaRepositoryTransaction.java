...
public class DatabaseKeyStoreJpaRepositoryTransaction implements DatabaseKeyStoreRepositoryTransaction{
   @NonNull EntityTransaction transaction;

   public static boolean isClosable(DatabaseKeyStoreJpaRepositoryTransaction dbTransaction)
   {
      return dbTransaction!=null && dbTransaction.getTransaction()!=null && dbTransaction.getTransaction().isActive() ;
   }
}
