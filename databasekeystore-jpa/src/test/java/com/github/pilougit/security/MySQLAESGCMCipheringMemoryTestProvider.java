...
public class MySQLAESGCMCipheringMemoryTestProvider extends CoreTestProvider {
    protected DatabaseKeyStoreRepository getDatabaseKeyStore()
    {


        return new DatabaseKeyStoreJpaRepository(EntityManagerFactory.createEntityManagerMYSQLDB());
    }
